...
function sumArray(sumAarr) { //eslint-disable-line
  var newSumArray = (sum(sum(testArray[0], testArray[1])[0], testArray[2])[0]);
  return [newSumArray, testArray + ' was passed in as an array of numbers, and ' + newSumArray + ' is their sum.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  return [newProductArray, 'The numbers ' + testArray + ' have a product of ' + newProductArray + '.'];
}
